...
function toApp(row) {
  return {
    ...
    showPricePerDay: row.show_price_per_day ?? true,
    pricePerHour: row.price_per_hour,
    showPricePerHour: row.show_price_per_hour ?? true,
...
function toDB(prop) {
  return {
    ...
    show_price_per_day: prop.showPricePerDay ?? true,
    price_per_hour: prop.pricePerHour,
    show_price_per_hour: prop.showPricePerHour ?? true,
